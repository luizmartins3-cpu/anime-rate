...
<style>
    ...
    .details-img { border-radius: 24px; overflow: hidden; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.4); border: 1px solid var(--glass-border); position: sticky; top: 100px; }
    .details-img img { width: 100%; height: auto; transition: transform 0.5s ease; }
    .details-info h1 { font-size: 3.5rem; font-weight: 900; margin-bottom: 1.5rem; letter-spacing: -0.05em; line-height: 1.1; background: var(--title-gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
    .details-meta { display: flex; gap: 1rem; margin-bottom: 2.5rem; flex-wrap: wrap; }
    .meta-item { display: flex; align-items: center; gap: 0.6rem; color: var(--text-light); background: var(--filter-bg); padding: 0.6rem 1.25rem; border-radius: 12px; font-weight: 600; font-size: 0.9rem; border: 1px solid var(--glass-border); backdrop-filter: blur(10px); }
    ...
    .video-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 32px; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3); border: 1px solid var(--glass-border); }
